...
public static class RedStarLinq
{
	...
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, TKey> function, Func<T, TValue> function2, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, TKey> function, Func<T, int, TValue> function2, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, TKey> function, Func<T, TValue> function2, IEqualityComparer<TKey> comparer, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), comparer, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, TKey> function, Func<T, int, TValue> function2, IEqualityComparer<TKey> comparer, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), comparer, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, TKey> function, Func<T, TValue> function2, Func<TKey, TKey, bool> equalFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), equalFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, TKey> function, Func<T, int, TValue> function2, Func<TKey, TKey, bool> equalFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), equalFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, TKey> function, Func<T, TValue> function2, Func<TKey, TKey, bool> equalFunction, Func<TKey, int> hashCodeFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), equalFunction, hashCodeFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, TKey> function, Func<T, int, TValue> function2, Func<TKey, TKey, bool> equalFunction, Func<TKey, int> hashCodeFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), ToList(source, function2), equalFunction, hashCodeFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, (TKey, TValue)> function, bool unordered = false) where TKey : notnull => new(ToList(source, function), unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, (TKey, TValue)> function, bool unordered = false) where TKey : notnull => new(ToList(source, function), unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, (TKey, TValue)> function, IEqualityComparer<TKey> comparer, bool unordered = false) where TKey : notnull => new(ToList(source, function), comparer, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, (TKey, TValue)> function, IEqualityComparer<TKey> comparer, bool unordered = false) where TKey : notnull => new(ToList(source, function), comparer, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, (TKey, TValue)> function, Func<TKey, TKey, bool> equalFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), equalFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, (TKey, TValue)> function, Func<TKey, TKey, bool> equalFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), equalFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, (TKey, TValue)> function, Func<TKey, TKey, bool> equalFunction, Func<TKey, int> hashCodeFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), equalFunction, hashCodeFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, (TKey, TValue)> function, Func<TKey, TKey, bool> equalFunction, Func<TKey, int> hashCodeFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), equalFunction, hashCodeFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, KeyValuePair<TKey, TValue>> function, bool unordered = false) where TKey : notnull => new(ToList(source, function), unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, KeyValuePair<TKey, TValue>> function, bool unordered = false) where TKey : notnull => new(ToList(source, function), unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, KeyValuePair<TKey, TValue>> function, IEqualityComparer<TKey> comparer, bool unordered = false) where TKey : notnull => new(ToList(source, function), comparer, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, KeyValuePair<TKey, TValue>> function, IEqualityComparer<TKey> comparer, bool unordered = false) where TKey : notnull => new(ToList(source, function), comparer, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, KeyValuePair<TKey, TValue>> function, Func<TKey, TKey, bool> equalFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), equalFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, int, KeyValuePair<TKey, TValue>> function, Func<TKey, TKey, bool> equalFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), equalFunction, unordered);
	public static Dictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(this IEnumerable<T> source, Func<T, KeyValuePair<TKey, TValue>> function, Func<TKey, TKey, bool> equalFunction, Func<TKey, int> hashCodeFunction, bool unordered = false) where TKey : notnull => new(ToList(source, function), equalFunction, hashCodeFunction, unordered);
