...
public partial class Form1 : Form
{
	...
	""";
		...
		string ReplaceMatches(string input, Match match) => input.Replace("$1", match.Groups[1].Value).Replace("$2?", match.Groups[2].Value == "TResult" || match.Groups[2].Value == "" ? "1" : "0").Replace("$2\\?", "$2?").Replace("$2", match.Groups[2].Value == "" ? "TResult" : match.Groups[2].Value).Replace("$3{star}", match.Groups[4].Value == "*" ? "0" : match.Groups[3].Value).Replace("$!{f}{star}", match.Groups[4].Value == "*" || match.Groups[6].Value == "0" ? "1" : "0").Replace("$!{star}", match.Groups[4].Value == "*" ? "1" : "0").Replace("$3?", match.Groups[3].Value == "" ? "1" : "0").Replace("$3", match.Groups[3].Value).Replace("${f}{star}", match.Groups[4].Value == "*" || match.Groups[6].Value == "0" ? "0" : "1").Replace("${star}", match.Groups[4].Value == "*" ? "0" : "1").Replace("${p}", match.Groups[5].Value);
