...
public static class RedStarLinqRemoveDoubles
{
	...
	public static NList<T> RemoveDoubles<T, TResult>(this NList<T> source, Func<T, TResult> function) where T : unmanaged where TResult : unmanaged
	{
		ArgumentNullException.ThrowIfNull(function);
		ListHashSet<TResult> hs = new(G.EqualityComparer<TResult>.Default);
		var length = source.Length;
	...
	public static NList<T> RemoveDoubles<T, TResult>(this NList<T> source, Func<T, int, TResult> function) where T : unmanaged where TResult : unmanaged
	{
		ArgumentNullException.ThrowIfNull(function);
		ListHashSet<TResult> hs = new(G.EqualityComparer<TResult>.Default);
		var length = source.Length;
	...
	public static NList<T> RemoveDoubles<T>(this NList<T> source) where T : unmanaged
	{
		ListHashSet<T> hs = new(G.EqualityComparer<T>.Default);
		var length = source.Length;
		NList<T> result = new(length);
	...
	public static NList<T> RemoveDoubles<T, TResult>(this NList<T> source, Func<T, TResult> function, Func<TResult, TResult, bool> equalFunction) where T : unmanaged where TResult : unmanaged
	{
		ArgumentNullException.ThrowIfNull(function);
		ListHashSet<TResult> hs = new(new EComparer<TResult>(equalFunction));
		var length = source.Length;
	...
	public static NList<T> RemoveDoubles<T, TResult>(this NList<T> source, Func<T, int, TResult> function, Func<TResult, TResult, bool> equalFunction) where T : unmanaged where TResult : unmanaged
	{
		ArgumentNullException.ThrowIfNull(function);
		ListHashSet<TResult> hs = new(new EComparer<TResult>(equalFunction));
		var length = source.Length;
	...
	public static NList<T> RemoveDoubles<T>(this NList<T> source, Func<T, T, bool> equalFunction) where T : unmanaged
	{
		ListHashSet<T> hs = new(new EComparer<T>(equalFunction));
		var length = source.Length;
		NList<T> result = new(length);
	...
	public static NList<T> RemoveDoubles<T, TResult>(this NList<T> source, Func<T, TResult> function, Func<TResult, TResult, bool> equalFunction, Func<TResult, int> hashCodeFunction) where T : unmanaged where TResult : unmanaged
	{
		ArgumentNullException.ThrowIfNull(function);
		ListHashSet<TResult> hs = new(new EComparer<TResult>(equalFunction, hashCodeFunction));
		var length = source.Length;
	...
	public static NList<T> RemoveDoubles<T, TResult>(this NList<T> source, Func<T, int, TResult> function, Func<TResult, TResult, bool> equalFunction, Func<TResult, int> hashCodeFunction) where T : unmanaged where TResult : unmanaged
	{
		ArgumentNullException.ThrowIfNull(function);
		ListHashSet<TResult> hs = new(new EComparer<TResult>(equalFunction, hashCodeFunction));
		var length = source.Length;
	...
	public static NList<T> RemoveDoubles<T>(this NList<T> source, Func<T, T, bool> equalFunction, Func<T, int> hashCodeFunction) where T : unmanaged
	{
		ListHashSet<T> hs = new(new EComparer<T>(equalFunction, hashCodeFunction));
		var length = source.Length;
		NList<T> result = new(length);
