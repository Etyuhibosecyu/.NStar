...
public class UnsignedLongDecimalTests
{
	...
	l1:
		...
		void Validate()
		{
			...
			Assert.IsLessThanOrEqualTo(MpuT.PowerOf10(decLengthDiffClamped), (expected - actual).Abs());
	...
	l1:
		...
		void Validate()
		{
			...
			Assert.IsLessThanOrEqualTo(MpuT.PowerOf10(maxMantissaLength), (expected - actual).Abs());
