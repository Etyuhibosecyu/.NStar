...
public static class Global
{
	...
	internal static readonly ImmutableArray<bool> bitList2 = ImmutableArray.Create(new BitList(135, [4186021589, 210265814, 981043]).SetAll(false, ..5).SetAll(true, ^71..^1).ToArray());
