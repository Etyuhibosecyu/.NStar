...
public class OptimumTests
{
	...
	{
		var mpzT = a.FindLastMax(x => x.PowerMod(new MpzT(power), new(mod))) ?? MpzT.Zero;
		var optimum = list3.Length == 0 ? 0 : E.MaxBy(E.Reverse(list3), x => BigInteger.ModPow(x, power, mod));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax((x, index) => x.PowerMod(new MpzT(power * index), new(mod))) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax(x => (decimal)((double)x / 1000000000000 / 1000000000000)) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MaxBy(E.Reverse(list3), x => (decimal)((double)x / 1000000000000 / 1000000000000));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax((x, index) => (decimal)((double)x / 1000000000000 / 1000000000000) * (index % 5)) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax(x => (double)x / 1000000000000) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MaxBy(E.Reverse(list3), x => (double)x / 1000000000000);
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax((x, index) => (double)x / 1000000000000 * (index % 5)) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax(x => (int)x) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MaxBy(E.Reverse(list3), x => (int)(uint)(x % 4294967296));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax((x, index) => (int)(x * (index % 5))) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax(x => (uint)x) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MaxBy(E.Reverse(list3), x => (uint)(x % 4294967296));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMax((x, index) => (uint)(x * (index % 5))) ?? MpzT.Zero;
	...
	{
		var mpzT = a.FindLastMin(x => x.PowerMod(new MpzT(power), new(mod))) ?? MpzT.Zero;
		var optimum = list3.Length == 0 ? 0 : E.MinBy(E.Reverse(list3), x => BigInteger.ModPow(x, power, mod));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin((x, index) => x.PowerMod(new MpzT(power * (index + 1)), new(mod))) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin(x => (decimal)((double)x / 1000000000000 / 1000000000000)) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MinBy(E.Reverse(list3), x => (decimal)((double)x / 1000000000000 / 1000000000000));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin((x, index) => (decimal)((double)x / 1000000000000 / 1000000000000) * ((index + 1) % 5)) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin(x => (double)x / 1000000000000) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MinBy(E.Reverse(list3), x => (double)x / 1000000000000);
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin((x, index) => (double)x / 1000000000000 * ((index + 1) % 5)) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin(x => (int)x) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MinBy(E.Reverse(list3), x => (int)(uint)(x % 4294967296));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin((x, index) => (int)(x * ((index + 1) % 5))) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin(x => (uint)x) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MinBy(E.Reverse(list3), x => (uint)(x % 4294967296));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindLastMin((x, index) => (uint)(x * ((index + 1) % 5))) ?? MpzT.Zero;
	...
	{
		var mpzT = a.FindMax(x => x.PowerMod(new MpzT(power), new(mod))) ?? MpzT.Zero;
		var optimum = list3.Length == 0 ? 0 : E.MaxBy(list3, x => BigInteger.ModPow(x, power, mod));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindMax((x, index) => x.PowerMod(new MpzT(power * index), new(mod))) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MaxBy(E.Select(list3, (elem, index) => (elem, index)), x => BigInteger.ModPow(x.elem, power * x.index, mod)).elem;
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindMax(x => (decimal)((double)x / 1000000000000 / 1000000000000)) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MaxBy(list3, x => (decimal)((double)x / 1000000000000 / 1000000000000));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindMax((x, index) => (decimal)((double)x / 1000000000000 / 1000000000000) * (index % 5)) ?? MpzT.Zero;
	...
	{
		var mpzT = a.FindMin(x => x.PowerMod(new MpzT(power), new(mod))) ?? MpzT.Zero;
		var optimum = list3.Length == 0 ? 0 : E.MinBy(list3, x => BigInteger.ModPow(x, power, mod));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindMin((x, index) => x.PowerMod(new MpzT(power * (index + 1)), new(mod))) ?? MpzT.Zero;
		...
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindMin(x => (decimal)((double)x / 1000000000000 / 1000000000000)) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.MinBy(list3, x => (decimal)((double)x / 1000000000000 / 1000000000000));
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.FindMin((x, index) => (decimal)((double)x / 1000000000000 / 1000000000000) * ((index + 1) % 5)) ?? MpzT.Zero;
	...
	{
		var mpzT = a.Progression((x, y) => x + y) ?? MpzT.Zero;
		var optimum = list3.Length == 0 ? 0 : E.Aggregate(list3, (BigInteger)0, (x, y) => x + y);
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.Convert(x => x.PowerMod(new MpzT(power), new(mod))).Progression((x, y) => x + y) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.Aggregate(E.Select(list3, x => BigInteger.ModPow(x, power, mod)), (BigInteger)0, (x, y) => x + y);
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.Convert((x, index) => x.PowerMod(new MpzT(power * index), new(mod))).Progression((x, y) => x + y) ?? MpzT.Zero;
		...
		Assert.AreEqual(longOptimum, @long);
		mpzT = a.Progression((MpzT)0, (x, y) => x + y) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.Aggregate(list3, (BigInteger)0, (x, y) => x + y);
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.Convert(x => x.PowerMod(new MpzT(power), new(mod))).Progression((MpzT)0, (x, y) => x + y) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.Aggregate(E.Select(list3, x => BigInteger.ModPow(x, power, mod)), (BigInteger)0, (x, y) => x + y);
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
		mpzT = a.Convert((x, index) => x.PowerMod(new MpzT(power * index), new(mod))).Progression((MpzT)0, (x, y) => x + y) ?? MpzT.Zero;
		optimum = list3.Length == 0 ? 0 : E.Aggregate(E.Select(list3, (x, index) => BigInteger.ModPow(x, power * index, mod)), (BigInteger)0, (x, y) => x + y);
		Assert.AreEqual(optimum, new BigInteger([.. mpzT.ToByteArray(-1), 0]));
