...
public class ListTests
{
	...
	public void TestAdd()
	{
		...
		b = new G.List<string>(list) { defaultString };
		Assert.IsTrue(a.Equals(b));
		Assert.IsTrue(E.SequenceEqual(b, a));
	}
	...
	public void TestAddRange()
	{
		...
		b = new G.List<string>(list);
		b.AddRange(defaultCollection.ToList().Copy().Insert(0, "XXX").GetSlice(1));
		Assert.IsTrue(a.Equals(b));
		Assert.IsTrue(E.SequenceEqual(b, a));
		a = list.ToList().AddRange(defaultCollection.Prepend("XXX"));
		b = new G.List<string>(list);
		b.AddRange(defaultCollection.Prepend("XXX"));
		Assert.IsTrue(a.Equals(b));
		Assert.IsTrue(E.SequenceEqual(b, a));
		a = list.ToList().AddRange(enumerable);
		b = new G.List<string>(list);
		b.AddRange(enumerable);
		Assert.IsTrue(a.Equals(b));
		Assert.IsTrue(E.SequenceEqual(b, a));
		a = list.ToList().AddRange(enumerable2);
		b = new G.List<string>(list);
		b.AddRange(enumerable2);
		Assert.IsTrue(a.Equals(b));
		Assert.IsTrue(E.SequenceEqual(b, a));
