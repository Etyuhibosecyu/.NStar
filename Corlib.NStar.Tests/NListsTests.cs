...
public class StringTests
{
	...
	public void TestEquals()
	{
		for (var i = 0; i < 1000; i++)
		{
			...
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new String(E.Append(b, Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new String(E.Skip(b, 1));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new String(E.Prepend(b, Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new String(E.SkipLast(b, 1));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new String(E.Append(E.SkipLast(b, 1), Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new String(E.Prepend(E.Skip(b, 1), Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = [];
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new List<char>(a);
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new List<char>(E.Append(b, Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new List<char>(E.Skip(b, 1));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new List<char>(E.Prepend(b, Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new List<char>(E.SkipLast(b, 1));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new List<char>(E.Append(E.SkipLast(b, 1), Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new List<char>(E.Prepend(E.Skip(b, 1), Next()));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = [];
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = E.ToArray(a);
			...
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new string(E.ToArray(E.Append(b, Next())));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new string(E.ToArray(E.Skip(b, 1)));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new string(E.ToArray(E.Prepend(b, Next())));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new string(E.ToArray(E.SkipLast(b, 1)));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new string(E.ToArray(E.Append(E.SkipLast(b, 1), Next())));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = new string(E.ToArray(E.Prepend(E.Skip(b, 1), Next())));
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = [];
			Assert.AreEqual(a.Equals(b), E.SequenceEqual(a, b));
			b = E.Select(a, x => x);
