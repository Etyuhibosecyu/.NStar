...
public static partial class Mpir
{
	...
	//
	private static readonly __xmpir_mpz_init xmpir_mpz_init = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_init>(__ptr__xmpir_mpz_init);
	private static readonly __xmpir_mpz_init2 xmpir_mpz_init2 = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_init2>(__ptr__xmpir_mpz_init2);
	private static readonly __xmpir_mpz_init_set xmpir_mpz_init_set = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_init_set>(__ptr__xmpir_mpz_init_set);
	private static readonly __xmpir_mpz_init_set_ui xmpir_mpz_init_set_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_init_set_ui>(__ptr__xmpir_mpz_init_set_ui);
	private static readonly __xmpir_mpz_init_set_si xmpir_mpz_init_set_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_init_set_si>(__ptr__xmpir_mpz_init_set_si);
	private static readonly __xmpir_mpz_init_set_d xmpir_mpz_init_set_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_init_set_d>(__ptr__xmpir_mpz_init_set_d);
	private static readonly __xmpir_mpz_init_set_str xmpir_mpz_init_set_str = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_init_set_str>(__ptr__xmpir_mpz_init_set_str);
	private static readonly __xmpir_mpq_init xmpir_mpq_init = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_init>(__ptr__xmpir_mpq_init);
	private static readonly __xmpir_mpf_init2 xmpir_mpf_init2 = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_init2>(__ptr__xmpir_mpf_init2);
	private static readonly __xmpir_mpf_init_set xmpir_mpf_init_set = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_init_set>(__ptr__xmpir_mpf_init_set);
	private static readonly __xmpir_mpf_init_set_ui xmpir_mpf_init_set_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_init_set_ui>(__ptr__xmpir_mpf_init_set_ui);
	private static readonly __xmpir_mpf_init_set_si xmpir_mpf_init_set_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_init_set_si>(__ptr__xmpir_mpf_init_set_si);
	private static readonly __xmpir_mpf_init_set_d xmpir_mpf_init_set_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_init_set_d>(__ptr__xmpir_mpf_init_set_d);
	private static readonly __xmpir_mpf_init_set_str xmpir_mpf_init_set_str = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_init_set_str>(__ptr__xmpir_mpf_init_set_str);
	private static readonly __xmpir_mpz_clear xmpir_mpz_clear = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_clear>(__ptr__xmpir_mpz_clear);
	private static readonly __xmpir_mpq_clear xmpir_mpq_clear = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_clear>(__ptr__xmpir_mpq_clear);
	private static readonly __xmpir_mpf_clear xmpir_mpf_clear = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_clear>(__ptr__xmpir_mpf_clear);
	private static readonly __xmpir_xmpir_dummy xmpir_xmpir_dummy = Marshal.GetDelegateForFunctionPointer<__xmpir_xmpir_dummy>(__ptr__xmpir_xmpir_dummy);
	private static readonly __xmpir_xmpir_dummy_add xmpir_xmpir_dummy_add = Marshal.GetDelegateForFunctionPointer<__xmpir_xmpir_dummy_add>(__ptr__xmpir_xmpir_dummy_add);
	private static readonly __xmpir_xmpir_dummy_3mpz xmpir_xmpir_dummy_3mpz = Marshal.GetDelegateForFunctionPointer<__xmpir_xmpir_dummy_3mpz>(__ptr__xmpir_xmpir_dummy_3mpz);
	private static readonly __xmpir_gmp_randinit_default xmpir_gmp_randinit_default = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_randinit_default>(__ptr__xmpir_gmp_randinit_default);
	private static readonly __xmpir_gmp_randinit_mt xmpir_gmp_randinit_mt = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_randinit_mt>(__ptr__xmpir_gmp_randinit_mt);
	private static readonly __xmpir_gmp_randinit_lc_2exp xmpir_gmp_randinit_lc_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_randinit_lc_2exp>(__ptr__xmpir_gmp_randinit_lc_2exp);
	private static readonly __xmpir_gmp_randinit_set xmpir_gmp_randinit_set = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_randinit_set>(__ptr__xmpir_gmp_randinit_set);
	private static readonly __xmpir_gmp_randclear xmpir_gmp_randclear = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_randclear>(__ptr__xmpir_gmp_randclear);
	private static readonly __xmpir_gmp_randseed xmpir_gmp_randseed = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_randseed>(__ptr__xmpir_gmp_randseed);
	private static readonly __xmpir_gmp_randseed_ui xmpir_gmp_randseed_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_randseed_ui>(__ptr__xmpir_gmp_randseed_ui);
	private static readonly __xmpir_gmp_urandomb_ui xmpir_gmp_urandomb_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_urandomb_ui>(__ptr__xmpir_gmp_urandomb_ui);
	private static readonly __xmpir_gmp_urandomm_ui xmpir_gmp_urandomm_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_gmp_urandomm_ui>(__ptr__xmpir_gmp_urandomm_ui);
	private static readonly __xmpir_mpz_realloc2 xmpir_mpz_realloc2 = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_realloc2>(__ptr__xmpir_mpz_realloc2);
	private static readonly __xmpir_mpf_set_default_prec xmpir_mpf_set_default_prec = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_default_prec>(__ptr__xmpir_mpf_set_default_prec);
	private static readonly __xmpir_mpf_get_default_prec xmpir_mpf_get_default_prec = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_get_default_prec>(__ptr__xmpir_mpf_get_default_prec);
	private static readonly __xmpir_mpz_set xmpir_mpz_set = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_set>(__ptr__xmpir_mpz_set);
	private static readonly __xmpir_mpz_set_ui xmpir_mpz_set_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_set_ui>(__ptr__xmpir_mpz_set_ui);
	private static readonly __xmpir_mpz_set_si xmpir_mpz_set_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_set_si>(__ptr__xmpir_mpz_set_si);
	private static readonly __xmpir_mpz_set_d xmpir_mpz_set_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_set_d>(__ptr__xmpir_mpz_set_d);
	private static readonly __xmpir_mpz_set_q xmpir_mpz_set_q = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_set_q>(__ptr__xmpir_mpz_set_q);
	private static readonly __xmpir_mpz_set_f xmpir_mpz_set_f = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_set_f>(__ptr__xmpir_mpz_set_f);
	private static readonly __xmpir_mpz_set_str xmpir_mpz_set_str = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_set_str>(__ptr__xmpir_mpz_set_str);
	private static readonly __xmpir_mpz_swap xmpir_mpz_swap = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_swap>(__ptr__xmpir_mpz_swap);
	private static readonly __xmpir_mpz_get_ui xmpir_mpz_get_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_get_ui>(__ptr__xmpir_mpz_get_ui);
	private static readonly __xmpir_mpz_get_si xmpir_mpz_get_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_get_si>(__ptr__xmpir_mpz_get_si);
	private static readonly __xmpir_mpz_get_d xmpir_mpz_get_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_get_d>(__ptr__xmpir_mpz_get_d);
	private static readonly __xmpir_mpz_get_string xmpir_mpz_get_string = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_get_string>(__ptr__xmpir_mpz_get_string);
	private static readonly __xmpir_mpz_add xmpir_mpz_add = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_add>(__ptr__xmpir_mpz_add);
	private static readonly __xmpir_mpz_add_ui xmpir_mpz_add_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_add_ui>(__ptr__xmpir_mpz_add_ui);
	private static readonly __xmpir_mpz_sub xmpir_mpz_sub = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_sub>(__ptr__xmpir_mpz_sub);
	private static readonly __xmpir_mpz_sub_ui xmpir_mpz_sub_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_sub_ui>(__ptr__xmpir_mpz_sub_ui);
	private static readonly __xmpir_mpz_ui_sub xmpir_mpz_ui_sub = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_ui_sub>(__ptr__xmpir_mpz_ui_sub);
	private static readonly __xmpir_mpz_mul xmpir_mpz_mul = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_mul>(__ptr__xmpir_mpz_mul);
	private static readonly __xmpir_mpz_mul_si xmpir_mpz_mul_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_mul_si>(__ptr__xmpir_mpz_mul_si);
	private static readonly __xmpir_mpz_mul_ui xmpir_mpz_mul_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_mul_ui>(__ptr__xmpir_mpz_mul_ui);
	private static readonly __xmpir_mpz_addmul xmpir_mpz_addmul = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_addmul>(__ptr__xmpir_mpz_addmul);
	private static readonly __xmpir_mpz_addmul_ui xmpir_mpz_addmul_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_addmul_ui>(__ptr__xmpir_mpz_addmul_ui);
	private static readonly __xmpir_mpz_submul xmpir_mpz_submul = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_submul>(__ptr__xmpir_mpz_submul);
	private static readonly __xmpir_mpz_submul_ui xmpir_mpz_submul_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_submul_ui>(__ptr__xmpir_mpz_submul_ui);
	private static readonly __xmpir_mpz_mul_2exp xmpir_mpz_mul_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_mul_2exp>(__ptr__xmpir_mpz_mul_2exp);
	private static readonly __xmpir_mpz_neg xmpir_mpz_neg = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_neg>(__ptr__xmpir_mpz_neg);
	private static readonly __xmpir_mpz_abs xmpir_mpz_abs = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_abs>(__ptr__xmpir_mpz_abs);
	private static readonly __xmpir_mpz_cdiv_q xmpir_mpz_cdiv_q = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_q>(__ptr__xmpir_mpz_cdiv_q);
	private static readonly __xmpir_mpz_cdiv_r xmpir_mpz_cdiv_r = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_r>(__ptr__xmpir_mpz_cdiv_r);
	private static readonly __xmpir_mpz_cdiv_qr xmpir_mpz_cdiv_qr = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_qr>(__ptr__xmpir_mpz_cdiv_qr);
	private static readonly __xmpir_mpz_cdiv_q_ui xmpir_mpz_cdiv_q_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_q_ui>(__ptr__xmpir_mpz_cdiv_q_ui);
	private static readonly __xmpir_mpz_cdiv_r_ui xmpir_mpz_cdiv_r_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_r_ui>(__ptr__xmpir_mpz_cdiv_r_ui);
	private static readonly __xmpir_mpz_cdiv_qr_ui xmpir_mpz_cdiv_qr_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_qr_ui>(__ptr__xmpir_mpz_cdiv_qr_ui);
	private static readonly __xmpir_mpz_cdiv_ui xmpir_mpz_cdiv_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_ui>(__ptr__xmpir_mpz_cdiv_ui);
	private static readonly __xmpir_mpz_cdiv_q_2exp xmpir_mpz_cdiv_q_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_q_2exp>(__ptr__xmpir_mpz_cdiv_q_2exp);
	private static readonly __xmpir_mpz_cdiv_r_2exp xmpir_mpz_cdiv_r_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cdiv_r_2exp>(__ptr__xmpir_mpz_cdiv_r_2exp);
	private static readonly __xmpir_mpz_fdiv_q xmpir_mpz_fdiv_q = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_q>(__ptr__xmpir_mpz_fdiv_q);
	private static readonly __xmpir_mpz_fdiv_r xmpir_mpz_fdiv_r = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_r>(__ptr__xmpir_mpz_fdiv_r);
	private static readonly __xmpir_mpz_fdiv_qr xmpir_mpz_fdiv_qr = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_qr>(__ptr__xmpir_mpz_fdiv_qr);
	private static readonly __xmpir_mpz_fdiv_q_ui xmpir_mpz_fdiv_q_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_q_ui>(__ptr__xmpir_mpz_fdiv_q_ui);
	private static readonly __xmpir_mpz_fdiv_r_ui xmpir_mpz_fdiv_r_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_r_ui>(__ptr__xmpir_mpz_fdiv_r_ui);
	private static readonly __xmpir_mpz_fdiv_qr_ui xmpir_mpz_fdiv_qr_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_qr_ui>(__ptr__xmpir_mpz_fdiv_qr_ui);
	private static readonly __xmpir_mpz_fdiv_ui xmpir_mpz_fdiv_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_ui>(__ptr__xmpir_mpz_fdiv_ui);
	private static readonly __xmpir_mpz_fdiv_q_2exp xmpir_mpz_fdiv_q_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_q_2exp>(__ptr__xmpir_mpz_fdiv_q_2exp);
	private static readonly __xmpir_mpz_fdiv_r_2exp xmpir_mpz_fdiv_r_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fdiv_r_2exp>(__ptr__xmpir_mpz_fdiv_r_2exp);
	private static readonly __xmpir_mpz_tdiv_q xmpir_mpz_tdiv_q = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_q>(__ptr__xmpir_mpz_tdiv_q);
	private static readonly __xmpir_mpz_tdiv_r xmpir_mpz_tdiv_r = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_r>(__ptr__xmpir_mpz_tdiv_r);
	private static readonly __xmpir_mpz_tdiv_qr xmpir_mpz_tdiv_qr = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_qr>(__ptr__xmpir_mpz_tdiv_qr);
	private static readonly __xmpir_mpz_tdiv_q_ui xmpir_mpz_tdiv_q_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_q_ui>(__ptr__xmpir_mpz_tdiv_q_ui);
	private static readonly __xmpir_mpz_tdiv_r_ui xmpir_mpz_tdiv_r_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_r_ui>(__ptr__xmpir_mpz_tdiv_r_ui);
	private static readonly __xmpir_mpz_tdiv_qr_ui xmpir_mpz_tdiv_qr_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_qr_ui>(__ptr__xmpir_mpz_tdiv_qr_ui);
	private static readonly __xmpir_mpz_tdiv_ui xmpir_mpz_tdiv_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_ui>(__ptr__xmpir_mpz_tdiv_ui);
	private static readonly __xmpir_mpz_tdiv_q_2exp xmpir_mpz_tdiv_q_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_q_2exp>(__ptr__xmpir_mpz_tdiv_q_2exp);
	private static readonly __xmpir_mpz_tdiv_r_2exp xmpir_mpz_tdiv_r_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tdiv_r_2exp>(__ptr__xmpir_mpz_tdiv_r_2exp);
	private static readonly __xmpir_mpz_mod xmpir_mpz_mod = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_mod>(__ptr__xmpir_mpz_mod);
	private static readonly __xmpir_mpz_mod_ui xmpir_mpz_mod_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_mod_ui>(__ptr__xmpir_mpz_mod_ui);
	private static readonly __xmpir_mpz_divexact xmpir_mpz_divexact = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_divexact>(__ptr__xmpir_mpz_divexact);
	private static readonly __xmpir_mpz_divexact_ui xmpir_mpz_divexact_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_divexact_ui>(__ptr__xmpir_mpz_divexact_ui);
	private static readonly __xmpir_mpz_divisible_p xmpir_mpz_divisible_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_divisible_p>(__ptr__xmpir_mpz_divisible_p);
	private static readonly __xmpir_mpz_divisible_ui_p xmpir_mpz_divisible_ui_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_divisible_ui_p>(__ptr__xmpir_mpz_divisible_ui_p);
	private static readonly __xmpir_mpz_divisible_2exp_p xmpir_mpz_divisible_2exp_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_divisible_2exp_p>(__ptr__xmpir_mpz_divisible_2exp_p);
	private static readonly __xmpir_mpz_congruent_p xmpir_mpz_congruent_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_congruent_p>(__ptr__xmpir_mpz_congruent_p);
	private static readonly __xmpir_mpz_congruent_ui_p xmpir_mpz_congruent_ui_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_congruent_ui_p>(__ptr__xmpir_mpz_congruent_ui_p);
	private static readonly __xmpir_mpz_congruent_2exp_p xmpir_mpz_congruent_2exp_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_congruent_2exp_p>(__ptr__xmpir_mpz_congruent_2exp_p);
	private static readonly __xmpir_mpz_powm xmpir_mpz_powm = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_powm>(__ptr__xmpir_mpz_powm);
	private static readonly __xmpir_mpz_powm_ui xmpir_mpz_powm_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_powm_ui>(__ptr__xmpir_mpz_powm_ui);
	private static readonly __xmpir_mpz_pow_ui xmpir_mpz_pow_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_pow_ui>(__ptr__xmpir_mpz_pow_ui);
	private static readonly __xmpir_mpz_ui_pow_ui xmpir_mpz_ui_pow_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_ui_pow_ui>(__ptr__xmpir_mpz_ui_pow_ui);
	private static readonly __xmpir_mpz_root xmpir_mpz_root = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_root>(__ptr__xmpir_mpz_root);
	private static readonly __xmpir_mpz_rootrem xmpir_mpz_rootrem = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_rootrem>(__ptr__xmpir_mpz_rootrem);
	private static readonly __xmpir_mpz_sqrt xmpir_mpz_sqrt = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_sqrt>(__ptr__xmpir_mpz_sqrt);
	private static readonly __xmpir_mpz_sqrtrem xmpir_mpz_sqrtrem = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_sqrtrem>(__ptr__xmpir_mpz_sqrtrem);
	private static readonly __xmpir_mpz_perfect_power_p xmpir_mpz_perfect_power_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_perfect_power_p>(__ptr__xmpir_mpz_perfect_power_p);
	private static readonly __xmpir_mpz_perfect_square_p xmpir_mpz_perfect_square_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_perfect_square_p>(__ptr__xmpir_mpz_perfect_square_p);
	private static readonly __xmpir_mpz_probab_prime_p xmpir_mpz_probab_prime_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_probab_prime_p>(__ptr__xmpir_mpz_probab_prime_p);
	private static readonly __xmpir_mpz_nextprime xmpir_mpz_nextprime = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_nextprime>(__ptr__xmpir_mpz_nextprime);
	private static readonly __xmpir_mpz_gcd xmpir_mpz_gcd = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_gcd>(__ptr__xmpir_mpz_gcd);
	private static readonly __xmpir_mpz_gcd_ui xmpir_mpz_gcd_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_gcd_ui>(__ptr__xmpir_mpz_gcd_ui);
	private static readonly __xmpir_mpz_gcdext xmpir_mpz_gcdext = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_gcdext>(__ptr__xmpir_mpz_gcdext);
	private static readonly __xmpir_mpz_lcm xmpir_mpz_lcm = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_lcm>(__ptr__xmpir_mpz_lcm);
	private static readonly __xmpir_mpz_lcm_ui xmpir_mpz_lcm_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_lcm_ui>(__ptr__xmpir_mpz_lcm_ui);
	private static readonly __xmpir_mpz_invert xmpir_mpz_invert = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_invert>(__ptr__xmpir_mpz_invert);
	private static readonly __xmpir_mpz_jacobi xmpir_mpz_jacobi = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_jacobi>(__ptr__xmpir_mpz_jacobi);
	private static readonly __xmpir_mpz_legendre xmpir_mpz_legendre = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_legendre>(__ptr__xmpir_mpz_legendre);
	private static readonly __xmpir_mpz_kronecker xmpir_mpz_kronecker = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_kronecker>(__ptr__xmpir_mpz_kronecker);
	private static readonly __xmpir_mpz_kronecker_si xmpir_mpz_kronecker_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_kronecker_si>(__ptr__xmpir_mpz_kronecker_si);
	private static readonly __xmpir_mpz_kronecker_ui xmpir_mpz_kronecker_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_kronecker_ui>(__ptr__xmpir_mpz_kronecker_ui);
	private static readonly __xmpir_mpz_si_kronecker xmpir_mpz_si_kronecker = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_si_kronecker>(__ptr__xmpir_mpz_si_kronecker);
	private static readonly __xmpir_mpz_ui_kronecker xmpir_mpz_ui_kronecker = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_ui_kronecker>(__ptr__xmpir_mpz_ui_kronecker);
	private static readonly __xmpir_mpz_remove xmpir_mpz_remove = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_remove>(__ptr__xmpir_mpz_remove);
	private static readonly __xmpir_mpz_fac_ui xmpir_mpz_fac_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fac_ui>(__ptr__xmpir_mpz_fac_ui);
	private static readonly __xmpir_mpz_bin_ui xmpir_mpz_bin_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_bin_ui>(__ptr__xmpir_mpz_bin_ui);
	private static readonly __xmpir_mpz_bin_uiui xmpir_mpz_bin_uiui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_bin_uiui>(__ptr__xmpir_mpz_bin_uiui);
	private static readonly __xmpir_mpz_fib_ui xmpir_mpz_fib_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fib_ui>(__ptr__xmpir_mpz_fib_ui);
	private static readonly __xmpir_mpz_fib2_ui xmpir_mpz_fib2_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fib2_ui>(__ptr__xmpir_mpz_fib2_ui);
	private static readonly __xmpir_mpz_lucnum_ui xmpir_mpz_lucnum_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_lucnum_ui>(__ptr__xmpir_mpz_lucnum_ui);
	private static readonly __xmpir_mpz_lucnum2_ui xmpir_mpz_lucnum2_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_lucnum2_ui>(__ptr__xmpir_mpz_lucnum2_ui);
	private static readonly __xmpir_mpz_cmp xmpir_mpz_cmp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cmp>(__ptr__xmpir_mpz_cmp);
	private static readonly __xmpir_mpz_cmp_d xmpir_mpz_cmp_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cmp_d>(__ptr__xmpir_mpz_cmp_d);
	private static readonly __xmpir_mpz_cmp_si xmpir_mpz_cmp_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cmp_si>(__ptr__xmpir_mpz_cmp_si);
	private static readonly __xmpir_mpz_cmp_ui xmpir_mpz_cmp_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cmp_ui>(__ptr__xmpir_mpz_cmp_ui);
	private static readonly __xmpir_mpz_cmpabs xmpir_mpz_cmpabs = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cmpabs>(__ptr__xmpir_mpz_cmpabs);
	private static readonly __xmpir_mpz_cmpabs_d xmpir_mpz_cmpabs_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cmpabs_d>(__ptr__xmpir_mpz_cmpabs_d);
	private static readonly __xmpir_mpz_cmpabs_ui xmpir_mpz_cmpabs_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_cmpabs_ui>(__ptr__xmpir_mpz_cmpabs_ui);
	private static readonly __xmpir_mpz_sgn xmpir_mpz_sgn = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_sgn>(__ptr__xmpir_mpz_sgn);
	private static readonly __xmpir_mpz_and xmpir_mpz_and = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_and>(__ptr__xmpir_mpz_and);
	private static readonly __xmpir_mpz_ior xmpir_mpz_ior = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_ior>(__ptr__xmpir_mpz_ior);
	private static readonly __xmpir_mpz_xor xmpir_mpz_xor = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_xor>(__ptr__xmpir_mpz_xor);
	private static readonly __xmpir_mpz_com xmpir_mpz_com = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_com>(__ptr__xmpir_mpz_com);
	private static readonly __xmpir_mpz_popcount xmpir_mpz_popcount = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_popcount>(__ptr__xmpir_mpz_popcount);
	private static readonly __xmpir_mpz_hamdist xmpir_mpz_hamdist = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_hamdist>(__ptr__xmpir_mpz_hamdist);
	private static readonly __xmpir_mpz_scan0 xmpir_mpz_scan0 = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_scan0>(__ptr__xmpir_mpz_scan0);
	private static readonly __xmpir_mpz_scan1 xmpir_mpz_scan1 = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_scan1>(__ptr__xmpir_mpz_scan1);
	private static readonly __xmpir_mpz_setbit xmpir_mpz_setbit = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_setbit>(__ptr__xmpir_mpz_setbit);
	private static readonly __xmpir_mpz_clrbit xmpir_mpz_clrbit = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_clrbit>(__ptr__xmpir_mpz_clrbit);
	private static readonly __xmpir_mpz_combit xmpir_mpz_combit = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_combit>(__ptr__xmpir_mpz_combit);
	private static readonly __xmpir_mpz_tstbit xmpir_mpz_tstbit = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_tstbit>(__ptr__xmpir_mpz_tstbit);
	private static readonly __xmpir_mpz_urandomb xmpir_mpz_urandomb = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_urandomb>(__ptr__xmpir_mpz_urandomb);
	private static readonly __xmpir_mpz_urandomm xmpir_mpz_urandomm = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_urandomm>(__ptr__xmpir_mpz_urandomm);
	private static readonly __xmpir_mpz_rrandomb xmpir_mpz_rrandomb = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_rrandomb>(__ptr__xmpir_mpz_rrandomb);
	private static readonly __xmpir_mpz_fits_uint_p xmpir_mpz_fits_uint_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fits_uint_p>(__ptr__xmpir_mpz_fits_uint_p);
	private static readonly __xmpir_mpz_fits_sint_p xmpir_mpz_fits_sint_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_fits_sint_p>(__ptr__xmpir_mpz_fits_sint_p);
	private static readonly __xmpir_mpz_odd_p xmpir_mpz_odd_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_odd_p>(__ptr__xmpir_mpz_odd_p);
	private static readonly __xmpir_mpz_even_p xmpir_mpz_even_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_even_p>(__ptr__xmpir_mpz_even_p);
	private static readonly __xmpir_mpz_sizeinbase xmpir_mpz_sizeinbase = Marshal.GetDelegateForFunctionPointer<__xmpir_mpz_sizeinbase>(__ptr__xmpir_mpz_sizeinbase);
	private static readonly __xmpir_mpq_canonicalize xmpir_mpq_canonicalize = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_canonicalize>(__ptr__xmpir_mpq_canonicalize);
	private static readonly __xmpir_mpq_set xmpir_mpq_set = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set>(__ptr__xmpir_mpq_set);
	private static readonly __xmpir_mpq_set_z xmpir_mpq_set_z = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_z>(__ptr__xmpir_mpq_set_z);
	private static readonly __xmpir_mpq_set_ui xmpir_mpq_set_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_ui>(__ptr__xmpir_mpq_set_ui);
	private static readonly __xmpir_mpq_set_si xmpir_mpq_set_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_si>(__ptr__xmpir_mpq_set_si);
	private static readonly __xmpir_mpq_set_str xmpir_mpq_set_str = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_str>(__ptr__xmpir_mpq_set_str);
	private static readonly __xmpir_mpq_swap xmpir_mpq_swap = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_swap>(__ptr__xmpir_mpq_swap);
	private static readonly __xmpir_mpq_get_d xmpir_mpq_get_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_get_d>(__ptr__xmpir_mpq_get_d);
	private static readonly __xmpir_mpq_set_d xmpir_mpq_set_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_d>(__ptr__xmpir_mpq_set_d);
	private static readonly __xmpir_mpq_set_f xmpir_mpq_set_f = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_f>(__ptr__xmpir_mpq_set_f);
	private static readonly __xmpir_mpq_get_string xmpir_mpq_get_string = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_get_string>(__ptr__xmpir_mpq_get_string);
	private static readonly __xmpir_mpq_add xmpir_mpq_add = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_add>(__ptr__xmpir_mpq_add);
	private static readonly __xmpir_mpq_sub xmpir_mpq_sub = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_sub>(__ptr__xmpir_mpq_sub);
	private static readonly __xmpir_mpq_mul xmpir_mpq_mul = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_mul>(__ptr__xmpir_mpq_mul);
	private static readonly __xmpir_mpq_mul_2exp xmpir_mpq_mul_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_mul_2exp>(__ptr__xmpir_mpq_mul_2exp);
	private static readonly __xmpir_mpq_div xmpir_mpq_div = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_div>(__ptr__xmpir_mpq_div);
	private static readonly __xmpir_mpq_div_2exp xmpir_mpq_div_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_div_2exp>(__ptr__xmpir_mpq_div_2exp);
	private static readonly __xmpir_mpq_neg xmpir_mpq_neg = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_neg>(__ptr__xmpir_mpq_neg);
	private static readonly __xmpir_mpq_abs xmpir_mpq_abs = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_abs>(__ptr__xmpir_mpq_abs);
	private static readonly __xmpir_mpq_inv xmpir_mpq_inv = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_inv>(__ptr__xmpir_mpq_inv);
	private static readonly __xmpir_mpq_cmp xmpir_mpq_cmp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_cmp>(__ptr__xmpir_mpq_cmp);
	private static readonly __xmpir_mpq_cmp_ui xmpir_mpq_cmp_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_cmp_ui>(__ptr__xmpir_mpq_cmp_ui);
	private static readonly __xmpir_mpq_cmp_si xmpir_mpq_cmp_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_cmp_si>(__ptr__xmpir_mpq_cmp_si);
	private static readonly __xmpir_mpq_sgn xmpir_mpq_sgn = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_sgn>(__ptr__xmpir_mpq_sgn);
	private static readonly __xmpir_mpq_equal xmpir_mpq_equal = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_equal>(__ptr__xmpir_mpq_equal);
	private static readonly __xmpir_mpq_get_num xmpir_mpq_get_num = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_get_num>(__ptr__xmpir_mpq_get_num);
	private static readonly __xmpir_mpq_get_den xmpir_mpq_get_den = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_get_den>(__ptr__xmpir_mpq_get_den);
	private static readonly __xmpir_mpq_set_num xmpir_mpq_set_num = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_num>(__ptr__xmpir_mpq_set_num);
	private static readonly __xmpir_mpq_set_den xmpir_mpq_set_den = Marshal.GetDelegateForFunctionPointer<__xmpir_mpq_set_den>(__ptr__xmpir_mpq_set_den);
	private static readonly __xmpir_mpf_get_prec xmpir_mpf_get_prec = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_get_prec>(__ptr__xmpir_mpf_get_prec);
	private static readonly __xmpir_mpf_set_prec xmpir_mpf_set_prec = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_prec>(__ptr__xmpir_mpf_set_prec);
	private static readonly __xmpir_mpf_set xmpir_mpf_set = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set>(__ptr__xmpir_mpf_set);
	private static readonly __xmpir_mpf_set_ui xmpir_mpf_set_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_ui>(__ptr__xmpir_mpf_set_ui);
	private static readonly __xmpir_mpf_set_si xmpir_mpf_set_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_si>(__ptr__xmpir_mpf_set_si);
	private static readonly __xmpir_mpf_set_d xmpir_mpf_set_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_d>(__ptr__xmpir_mpf_set_d);
	private static readonly __xmpir_mpf_set_z xmpir_mpf_set_z = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_z>(__ptr__xmpir_mpf_set_z);
	private static readonly __xmpir_mpf_set_q xmpir_mpf_set_q = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_q>(__ptr__xmpir_mpf_set_q);
	private static readonly __xmpir_mpf_set_str xmpir_mpf_set_str = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_set_str>(__ptr__xmpir_mpf_set_str);
	private static readonly __xmpir_mpf_swap xmpir_mpf_swap = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_swap>(__ptr__xmpir_mpf_swap);
	private static readonly __xmpir_mpf_get_d xmpir_mpf_get_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_get_d>(__ptr__xmpir_mpf_get_d);
	private static readonly __xmpir_mpf_get_d_2exp xmpir_mpf_get_d_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_get_d_2exp>(__ptr__xmpir_mpf_get_d_2exp);
	private static readonly __xmpir_mpf_get_si xmpir_mpf_get_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_get_si>(__ptr__xmpir_mpf_get_si);
	private static readonly __xmpir_mpf_get_ui xmpir_mpf_get_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_get_ui>(__ptr__xmpir_mpf_get_ui);
	private static readonly __xmpir_mpf_get_string xmpir_mpf_get_string = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_get_string>(__ptr__xmpir_mpf_get_string);
	private static readonly __xmpir_mpf_add xmpir_mpf_add = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_add>(__ptr__xmpir_mpf_add);
	private static readonly __xmpir_mpf_add_ui xmpir_mpf_add_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_add_ui>(__ptr__xmpir_mpf_add_ui);
	private static readonly __xmpir_mpf_sub xmpir_mpf_sub = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_sub>(__ptr__xmpir_mpf_sub);
	private static readonly __xmpir_mpf_ui_sub xmpir_mpf_ui_sub = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_ui_sub>(__ptr__xmpir_mpf_ui_sub);
	private static readonly __xmpir_mpf_sub_ui xmpir_mpf_sub_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_sub_ui>(__ptr__xmpir_mpf_sub_ui);
	private static readonly __xmpir_mpf_mul xmpir_mpf_mul = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_mul>(__ptr__xmpir_mpf_mul);
	private static readonly __xmpir_mpf_mul_ui xmpir_mpf_mul_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_mul_ui>(__ptr__xmpir_mpf_mul_ui);
	private static readonly __xmpir_mpf_div xmpir_mpf_div = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_div>(__ptr__xmpir_mpf_div);
	private static readonly __xmpir_mpf_ui_div xmpir_mpf_ui_div = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_ui_div>(__ptr__xmpir_mpf_ui_div);
	private static readonly __xmpir_mpf_div_ui xmpir_mpf_div_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_div_ui>(__ptr__xmpir_mpf_div_ui);
	private static readonly __xmpir_mpf_sqrt xmpir_mpf_sqrt = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_sqrt>(__ptr__xmpir_mpf_sqrt);
	private static readonly __xmpir_mpf_sqrt_ui xmpir_mpf_sqrt_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_sqrt_ui>(__ptr__xmpir_mpf_sqrt_ui);
	private static readonly __xmpir_mpf_pow_ui xmpir_mpf_pow_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_pow_ui>(__ptr__xmpir_mpf_pow_ui);
	private static readonly __xmpir_mpf_neg xmpir_mpf_neg = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_neg>(__ptr__xmpir_mpf_neg);
	private static readonly __xmpir_mpf_abs xmpir_mpf_abs = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_abs>(__ptr__xmpir_mpf_abs);
	private static readonly __xmpir_mpf_mul_2exp xmpir_mpf_mul_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_mul_2exp>(__ptr__xmpir_mpf_mul_2exp);
	private static readonly __xmpir_mpf_div_2exp xmpir_mpf_div_2exp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_div_2exp>(__ptr__xmpir_mpf_div_2exp);
	private static readonly __xmpir_mpf_cmp xmpir_mpf_cmp = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_cmp>(__ptr__xmpir_mpf_cmp);
	private static readonly __xmpir_mpf_cmp_d xmpir_mpf_cmp_d = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_cmp_d>(__ptr__xmpir_mpf_cmp_d);
	private static readonly __xmpir_mpf_cmp_ui xmpir_mpf_cmp_ui = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_cmp_ui>(__ptr__xmpir_mpf_cmp_ui);
	private static readonly __xmpir_mpf_cmp_si xmpir_mpf_cmp_si = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_cmp_si>(__ptr__xmpir_mpf_cmp_si);
	private static readonly __xmpir_mpf_eq xmpir_mpf_eq = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_eq>(__ptr__xmpir_mpf_eq);
	private static readonly __xmpir_mpf_reldiff xmpir_mpf_reldiff = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_reldiff>(__ptr__xmpir_mpf_reldiff);
	private static readonly __xmpir_mpf_sgn xmpir_mpf_sgn = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_sgn>(__ptr__xmpir_mpf_sgn);
	private static readonly __xmpir_mpf_ceil xmpir_mpf_ceil = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_ceil>(__ptr__xmpir_mpf_ceil);
	private static readonly __xmpir_mpf_floor xmpir_mpf_floor = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_floor>(__ptr__xmpir_mpf_floor);
	private static readonly __xmpir_mpf_trunc xmpir_mpf_trunc = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_trunc>(__ptr__xmpir_mpf_trunc);
	private static readonly __xmpir_mpf_integer_p xmpir_mpf_integer_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_integer_p>(__ptr__xmpir_mpf_integer_p);
	private static readonly __xmpir_mpf_fits_uint_p xmpir_mpf_fits_uint_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_fits_uint_p>(__ptr__xmpir_mpf_fits_uint_p);
	private static readonly __xmpir_mpf_fits_sint_p xmpir_mpf_fits_sint_p = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_fits_sint_p>(__ptr__xmpir_mpf_fits_sint_p);
	private static readonly __xmpir_mpf_urandomb xmpir_mpf_urandomb = Marshal.GetDelegateForFunctionPointer<__xmpir_mpf_urandomb>(__ptr__xmpir_mpf_urandomb);
}
