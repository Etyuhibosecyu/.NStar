...
public static class RedStarLinqMath
{
	...
	public static decimal Max(List<decimal> source) => Max(source.AsSpan());
	public static double Max(List<double> source) => Max(source.AsSpan());
	public static int Max(List<int> source) => Max(source.AsSpan());
	public static uint Max(List<uint> source) => Max(source.AsSpan());
	public static long Max(List<long> source) => Max(source.AsSpan());
	public static MpzT Max(List<MpzT> source) => Max(source.AsSpan());
	public static T? Max<T>(List<T?> source) => E.Max(source);
	...
	public static decimal Mean(List<decimal> source) => Mean(source.AsSpan());
	public static double Mean(List<double> source) => Mean(source.AsSpan());
	public static double Mean(List<int> source) => Mean(source.AsSpan());
	public static double Mean(List<uint> source) => Mean(source.AsSpan());
	public static double Mean(List<long> source) => Mean(source.AsSpan());
	public static double Mean(List<MpzT> source) => Mean(source.AsSpan());
	...
	public static decimal Median(List<decimal> source) => Median(source.AsSpan());
	public static double Median(List<double> source) => Median(source.AsSpan());
	public static int Median(List<int> source) => Median(source.AsSpan());
	public static uint Median(List<uint> source) => Median(source.AsSpan());
	public static long Median(List<long> source) => Median(source.AsSpan());
	public static MpzT Median(List<MpzT> source) => Median(source.AsSpan());
	...
	public static decimal Min(List<decimal> source) => Min(source.AsSpan());
	public static double Min(List<double> source) => Min(source.AsSpan());
	public static int Min(List<int> source) => Min(source.AsSpan());
	public static uint Min(List<uint> source) => Min(source.AsSpan());
	public static long Min(List<long> source) => Min(source.AsSpan());
	public static MpzT Min(List<MpzT> source) => Min(source.AsSpan());
	public static T? Min<T>(List<T?> source) => E.Min(source);
